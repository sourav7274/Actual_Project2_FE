...
export const NewLead = () => {
  ...
  return (
    <>
      <section className="my-6 py-6 px-3  rounded-lg  text-white max-w-3xl mx-auto">
        ...
        <form onSubmit={handleForm} className="space-y-5">
          ...
          <div>
            ...
            <input
              className="w-full rounded-lg bg-black p-3 placeholder:text-gray-200 text-sm focus:ring-2 focus:ring-red-400"
          ...
          <div>
            ...
            <select
              className="w-full bg-black text-gray-100 p-3 rounded-lg focus:ring-2 focus:ring-red-400"
              name="source"
          ...
          <div>
            ...
            <input
              className="w-full rounded-lg p-3 bg-black placeholder:text-gray-200 text-sm focus:ring-2 focus:ring-red-400"
          ...
          {/* Submit Button */}
          <button
            className="bg-gray-700 py-3 px-4 rounded-lg mt-5  hover:bg-gray-900 transition font-semibold text-lg"
            type="submit"
          >
            <div className="flex gap-3">
              <img
                className="h-[25px]"
                src="https://www.svgrepo.com/show/199943/upload.svg"
              />
              <p>Submit</p>
            </div>
          </button>
